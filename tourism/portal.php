...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Chào mừng đến với TMS- Site</div>
		<div class="masthead-heading text-uppercase">Khám phá tour du lịch của chúng tôi</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">Xem Tour</a>
	</div>
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-center">Gói tour</h2>
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">Khám phá gói <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
...
<section class="page-section" id="contact">
	<div class="container">
		<div class="text-center">
			...
			<h3 class="section-subheading text-muted">Gửi yêu cầu của bạn cho chúng tôi.</h3>
		</div>
		<!-- * * * * * * * * * * * * * * *-->
			...
			<div class="row align-items-stretch mb-5">
				<div class="col-md-6">
					<div class="form-group">
						<!-- Name input-->
						<input class="form-control" id="name" name="name" type="text" placeholder="Họ Tên *" required />
					</div>
					<div class="form-group">
						<!-- Email address input-->
					...
					<div class="form-group mb-md-0">
						<input class="form-control" id="subject" name="subject" type="subject" placeholder="Vấn đề *" required />
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group form-group-textarea mb-md-0">
						<!-- Message input-->
						<textarea class="form-control" id="message" name="message" placeholder="Lời nhắn *" required></textarea>
					</div>
				</div>
			</div>
			<div class="text-center"><button class="btn btn-primary btn-xl text-uppercase" id="submitButton" type="submit">Gửi tin</button></div>
		</form>
	</div>
</section>
<script>
